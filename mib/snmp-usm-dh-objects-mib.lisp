;;;; -*- Mode: Lisp -*-
;;;; Auto-generated from MIB:BASE;SNMP-USM-DH-OBJECTS-MIB.TXT by ASN.1 5.0
...
(define-textual-convention |DHKeyChange|
                           octet-string
                           (:status '|current|)
                           (:description
...
(defclass |UsmDHKickstartEntry|
          ...
          ((|usmDHKickstartIndex| :type |Integer32|)
           (|usmDHKickstartMyPublic| :type octet-string)
           (|usmDHKickstartMgrPublic| :type octet-string)
