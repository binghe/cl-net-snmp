...
(defclass |InetCidrRouteEntry| (sequence-type)
  ((|inetCidrRouteDestType| :type |InetAddressType|)
   ...
   (|inetCidrRouteNextHopAS| :type |InetAutonomousSystemNumber|)
...
(defclass |IpCidrRouteEntry| (sequence-type)
...
(defclass |IpForwardEntry| (sequence-type)
