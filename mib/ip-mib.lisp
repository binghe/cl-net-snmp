...
(defclass |Ipv4InterfaceEntry| (sequence-type)
...
(defclass |Ipv6InterfaceEntry| (sequence-type)
  ((|ipv6InterfaceIfIndex| :type |InterfaceIndex|)
   (|ipv6InterfaceReasmMaxSize| :type |Unsigned32|)
   (|ipv6InterfaceIdentifier| :type |Ipv6AddressIfIdentifierTC|)
...
(defclass |IpSystemStatsEntry| (sequence-type)
...
(defclass |IpIfStatsEntry| (sequence-type)
...
(defclass |IpAddressPrefixEntry| (sequence-type)
...
(defclass |IpAddressEntry| (sequence-type)
...
(defclass |IpNetToPhysicalEntry| (sequence-type)
...
(defclass |Ipv6ScopeZoneIndexEntry| (sequence-type)
  ((|ipv6ScopeZoneIndexIfIndex| :type |InterfaceIndex|)
   ...
   (|ipv6ScopeZoneIndexOrganizationLocal| :type |InetZoneIndex|)
...
(defclass |IpDefaultRouterEntry| (sequence-type)
...
(defclass |Ipv6RouterAdvertEntry| (sequence-type)
...
(defclass |IcmpStatsEntry| (sequence-type)
...
(defclass |IcmpMsgStatsEntry| (sequence-type)
...
(defclass |IpAddrEntry| (sequence-type)
...
(defclass |IpNetToMediaEntry| (sequence-type)
