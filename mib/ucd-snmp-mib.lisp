...
(define-textual-convention |UCDErrorFlag|
                           t
                           (:status '|current|)
                           (:description
                            "Represents a possible error condition"))

(define-textual-convention |UCDErrorFix|
                           t
                           (:status '|current|)
                           (:description
...
(defclass |PrEntry| (sequence-type)
...
(defclass |ExtEntry| (sequence-type)
...
(defclass |DskEntry| (sequence-type)
...
(defclass |LaEntry| (sequence-type)
...
(defclass |MrEntry| (sequence-type)
  ((|mrIndex| :type object-id) (|mrModuleName| :type |DisplayString|)))
...
(defclass |FileEntry| (sequence-type)
...
(defclass |LogMatchEntry| (sequence-type)
