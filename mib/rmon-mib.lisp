...
(defclass |EtherStatsEntry| (sequence-type)
...
(defclass |HistoryControlEntry| (sequence-type)
...
(defclass |EtherHistoryEntry| (sequence-type)
...
(defclass |AlarmEntry| (sequence-type)
...
(defclass |HostControlEntry| (sequence-type)
...
(defclass |HostTopNControlEntry| (sequence-type)
...
(defclass |MatrixControlEntry| (sequence-type)
...
(defclass |FilterEntry| (sequence-type)
...
(defclass |ChannelEntry| (sequence-type)
...
(defclass |BufferControlEntry| (sequence-type)
...
(defclass |CaptureBufferEntry| (sequence-type)
...
(defclass |EventEntry| (sequence-type)
...
(defclass |LogEntry| (sequence-type)
