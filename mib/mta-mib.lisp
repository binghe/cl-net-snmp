...
(defclass |MtaEntry| (sequence-type)
...
(defclass |MtaGroupEntry| (sequence-type)
  ((|mtaGroupIndex| :type integer)
   ...
   (|mtaGroupAccumulatedOutboundAssociations| :type |Counter32|)
   (|mtaGroupLastInboundActivity| :type |TimeInterval|)
   (|mtaGroupLastOutboundActivity| :type |TimeInterval|)
   (|mtaGroupLastOutboundAssociationAttempt| :type |TimeInterval|)
   ...
   (|mtaGroupOutboundConnectFailureReason| :type |SnmpAdminString|)
...
(defclass |MtaGroupAssociationEntry| (sequence-type)
...
(defclass |MtaGroupErrorEntry| (sequence-type)
