...
(defclass |TraceRouteCtlEntry| (sequence-type)
...
(defclass |TraceRouteResultsEntry| (sequence-type)
...
(defclass |TraceRouteProbeHistoryEntry| (sequence-type)
  ((|traceRouteProbeHistoryIndex| :type |Unsigned32|)
   ...
   (|traceRouteProbeHistoryStatus| :type |OperationResponseStatus|)
...
(defclass |TraceRouteHopsEntry| (sequence-type)
