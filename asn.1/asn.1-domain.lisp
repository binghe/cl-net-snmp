...
(DEFUN ASSIGNMENT40 (TYPE-ASSIGNMENT)
  (MAKE-ASSIGNMENT :TYPE :TYPE :VALUE TYPE-ASSIGNMENT))

(DEFUN ASSIGNMENT41 (VALUE-ASSIGNMENT)
  (MAKE-ASSIGNMENT :TYPE :VALUE :VALUE VALUE-ASSIGNMENT))

(DEFUN SYMBOLS-FROM-MODULE42
...
(DEFUN EXPORTS44 (DUMMY SYMBOL*\,1$ DUMMY1)
  (DECLARE (IGNORE DUMMY1 DUMMY))
  (MAKE-EXPORTS :LIST SYMBOL*\,1$))

(DEFUN EXPORTS45 (DUMMY DUMMY1 DUMMY2)
  (DECLARE (IGNORE DUMMY2 DUMMY1 DUMMY))
  (MAKE-EXPORTS :ALL-EXPORTS T))

(DEFUN MODULE-BODY46 (EXPORTS IMPORTS ASSIGNMENT*)
