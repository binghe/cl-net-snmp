...
(DEFUN ASSIGNMENT*45 (ASSIGNMENT ASSIGNMENT*)
  (MAKE-KB-SEQUENCE :FIRST ASSIGNMENT :REST ASSIGNMENT*))

(DEFUN SYMBOL*\,1$46 (SYMBOL |Rest-SYMBOL*,1$|)
  (MAKE-KB-SEQUENCE :FIRST SYMBOL :REST |Rest-SYMBOL*,1$|))

(DEFUN |Rest-SYMBOL*,1$47| (DUMMY SYMBOL |Rest-SYMBOL*,1$|)
  (DECLARE (IGNORE DUMMY))
  (MAKE-KB-SEQUENCE :FIRST SYMBOL :REST |Rest-SYMBOL*,1$|))

(DEFUN SYMBOLS-FROM-MODULE*48
...
(DEFUN SYMBOL+\,1$49 (SYMBOL) (MAKE-KB-SEQUENCE :FIRST SYMBOL))

(DEFUN SYMBOL+\,1$50 (SYMBOL DUMMY SYMBOL+\,1$)
  (DECLARE (IGNORE DUMMY))
  (MAKE-KB-SEQUENCE :FIRST SYMBOL :REST SYMBOL+\,1$))

(DEFUN GARBAGE+51 (GARBAGE) (MAKE-KB-SEQUENCE :FIRST GARBAGE))

(DEFUN GARBAGE+52 (GARBAGE GARBAGE+)
  (MAKE-KB-SEQUENCE :FIRST GARBAGE :REST GARBAGE+))

(DEFUN MODULE-REVISION*53 (MODULE-REVISION MODULE-REVISION*)
  (MAKE-KB-SEQUENCE :FIRST MODULE-REVISION :REST MODULE-REVISION*))

(DEFUN IDENTIFIER+\,1$54 (IDENTIFIER)
  (MAKE-KB-SEQUENCE :FIRST IDENTIFIER))

(DEFUN IDENTIFIER+\,1$55 (IDENTIFIER DUMMY IDENTIFIER+\,1$)
  (DECLARE (IGNORE DUMMY))
  (MAKE-KB-SEQUENCE :FIRST IDENTIFIER :REST IDENTIFIER+\,1$))

(DEFUN MODULE-COMPLIANCE-BODY+56 (MODULE-COMPLIANCE-BODY)
  (MAKE-KB-SEQUENCE :FIRST MODULE-COMPLIANCE-BODY))

(DEFUN MODULE-COMPLIANCE-BODY+57
...
(DEFUN OBJECT-TYPE-INDEX-VALUE+\,1$58 (OBJECT-TYPE-INDEX-VALUE)
  (MAKE-KB-SEQUENCE :FIRST OBJECT-TYPE-INDEX-VALUE))

(DEFUN OBJECT-TYPE-INDEX-VALUE+\,1$59
...
(DEFUN IDENTIFIER*\,1$60 (IDENTIFIER |Rest-IDENTIFIER*,1$|)
  (MAKE-KB-SEQUENCE :FIRST IDENTIFIER :REST |Rest-IDENTIFIER*,1$|))

(DEFUN |Rest-IDENTIFIER*,1$61| (DUMMY IDENTIFIER |Rest-IDENTIFIER*,1$|)
  (DECLARE (IGNORE DUMMY))
  (MAKE-KB-SEQUENCE :FIRST IDENTIFIER :REST |Rest-IDENTIFIER*,1$|))

(DEFUN MODULE-COMPLIANCE-ITEM*62
...
(DEFUN OBJ-ID-COMPONENT+63 (OBJ-ID-COMPONENT)
  (MAKE-KB-SEQUENCE :FIRST OBJ-ID-COMPONENT))

(DEFUN OBJ-ID-COMPONENT+64 (OBJ-ID-COMPONENT OBJ-ID-COMPONENT+)
  (MAKE-KB-SEQUENCE :FIRST OBJ-ID-COMPONENT :REST OBJ-ID-COMPONENT+))

(DEFUN NUMBERS+\|1$65 (NUMBERS) (MAKE-KB-SEQUENCE :FIRST NUMBERS))

(DEFUN NUMBERS+\|1$66 (NUMBERS DUMMY NUMBERS+\|1$)
  (DECLARE (IGNORE DUMMY))
  (MAKE-KB-SEQUENCE :FIRST NUMBERS :REST NUMBERS+\|1$))

(DEFUN SPLITED-NUMBERS+\|1$67 (SPLITED-NUMBERS)
  (MAKE-KB-SEQUENCE :FIRST SPLITED-NUMBERS))

(DEFUN SPLITED-NUMBERS+\|1$68
       (SPLITED-NUMBERS DUMMY SPLITED-NUMBERS+\|1$)
  (DECLARE (IGNORE DUMMY))
  (MAKE-KB-SEQUENCE :FIRST SPLITED-NUMBERS :REST SPLITED-NUMBERS+\|1$))

(DEFUN NAMED-NUMBER+\,1$69 (NAMED-NUMBER)
  (MAKE-KB-SEQUENCE :FIRST NAMED-NUMBER))

(DEFUN NAMED-NUMBER+\,1$70 (NAMED-NUMBER DUMMY NAMED-NUMBER+\,1$)
  (DECLARE (IGNORE DUMMY))
  (MAKE-KB-SEQUENCE :FIRST NAMED-NUMBER :REST NAMED-NUMBER+\,1$))

(DEFUN GARBAGE*71 (GARBAGE GARBAGE*)
  (MAKE-KB-SEQUENCE :FIRST GARBAGE :REST GARBAGE*))

(DEFUN NAME-AND-NUMBER-FORM72 (IDENTIFIER DUMMY NUMBER-FORM DUMMY1)
  (DECLARE (IGNORE DUMMY1 DUMMY))
  (MAKE-OBJ-ID-COMPONENT :NAME IDENTIFIER :VALUE NUMBER-FORM))

(DEFUN OBJECT-IDENTIFIER-VALUE73 (DUMMY OBJ-ID-COMPONENT+ DUMMY1)
  (DECLARE (IGNORE DUMMY1 DUMMY))
  (MAKE-OBJECT-IDENTIFIER-VALUE :VALUE OBJ-ID-COMPONENT+))

(DEFUN VALUE-ASSIGNMENT74 (IDENTIFIER TYPE DUMMY VALUE)
  (DECLARE (IGNORE DUMMY))
  (MAKE-VALUE-ASSIGNMENT :NAME IDENTIFIER :TYPE TYPE :VALUE VALUE))

(DEFUN VALUE-ASSIGNMENT75
...
(DEFUN ASSIGNMENT82 (TYPE-ASSIGNMENT)
  (MAKE-ASSIGNMENT :TYPE :TYPE :VALUE TYPE-ASSIGNMENT))

(DEFUN ASSIGNMENT83 (VALUE-ASSIGNMENT)
  (MAKE-ASSIGNMENT :TYPE :VALUE :VALUE VALUE-ASSIGNMENT))

(DEFUN SYMBOLS-FROM-MODULE84
...
(DEFUN IMPORTS85 (DUMMY SYMBOLS-FROM-MODULE* DUMMY1)
  (DECLARE (IGNORE DUMMY1 DUMMY))
  (MAKE-IMPORTS :VALID T :LIST SYMBOLS-FROM-MODULE*))

(DEFUN EXPORTS86 (DUMMY SYMBOL*\,1$ DUMMY1)
  (DECLARE (IGNORE DUMMY1 DUMMY))
  (MAKE-EXPORTS :LIST SYMBOL*\,1$))

(DEFUN EXPORTS87 (DUMMY DUMMY1 DUMMY2)
  (DECLARE (IGNORE DUMMY2 DUMMY1 DUMMY))
  (MAKE-EXPORTS :ALL-EXPORTS T))

(DEFUN MODULE-BODY88 (EXPORTS IMPORTS ASSIGNMENT*)
