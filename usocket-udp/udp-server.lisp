...
<DOCUMENTATION>
 ...
 <COPYRIGHT YEAR='2007-2008' AUTHOR='Chun Tian (binghe)' MARK='(C)'
            HREF='https://cl-net-snmp.svn.sourceforge.net/svnroot/cl-net-snmp/snmp/trunk/usocket-udp/udp-server.lisp'/>
 <CHRONOLOGY>
  <DELTA DATE='20080317'>create USOCKET UDP patch file "udp-server.lisp"</DELTA>
  </CHRONOLOGY>
 </DOCUMENTATION>
|#
